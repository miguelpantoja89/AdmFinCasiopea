...
Presidente INTEGER,
PRIMARY KEY (IdC),
FOREIGN KEY (Presidente) REFERENCES Propietarios (IdP) ON DELETE CASCADE,
...
PRIMARY KEY (IdPert),
UNIQUE(IdP,IdC),
FOREIGN KEY (IdP) REFERENCES Propietarios  ON DELETE CASCADE,
FOREIGN KEY (IdC) REFERENCES Comunidades  ON DELETE CASCADE
);
...
FOREIGN KEY(IdC) REFERENCES Comunidades  ON DELETE CASCADE,
FOREIGN KEY(IdEmpresa) REFERENCES Empresas  ON DELETE CASCADE
);
...
FOREIGN KEY (IdPresupuesto) REFERENCES Presupuestos  ON DELETE CASCADE
);
